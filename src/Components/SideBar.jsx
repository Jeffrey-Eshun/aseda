...
function SideBar() {
  ...
  return (
    <>
      <div className={menu ? "space-toggle" : null}>
          ...
          <nav className={menu ? "open" : "close"}>
            <ul>
              ...
              <NavLink to="/transaction" className="color">
                <li>
                  <LapTimerIcon /> Transaction
                </li>
              </NavLink>
              <NavLink to="/withdrawal" className="color">
                <li>
                  <EnvelopeClosedIcon /> Withdrawal
                </li>
              </NavLink>
            </ul>
          </nav>
